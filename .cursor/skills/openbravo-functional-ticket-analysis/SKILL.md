...
7. **Comparación obligatoria contra pares — antes de cerrar cualquier diagnóstico, incluida la conclusión de "no hay error" o "es el comportamiento esperado".** Distinguir el nivel correcto de comparación:
